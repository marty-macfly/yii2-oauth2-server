...
/**
 * SearchClientsModel represents the model behind the search form about `filsh\yii2\oauth2server\models\OauthClients`.
 */
class SearchClientsModel extends OauthClients
{
    /**
     * @inheritdoc
     */
